...
print("This is the entities detected by model en_ner_sci_md \n")

print(f"Extracted {len(diseases)} diseases: {diseases} \n")
with open(directory_path+ '/text_sci.txt', 'w') as fp:
...
with open('C:/Users/ASUS/Downloads/Assignment 2/text_sci.txt', 'w') as fp:
    for item in drugs:
        # write each item on a new line
        fp.write("drug extracted \n")
        fp.write("%s\n" % item)
    print('Done')
